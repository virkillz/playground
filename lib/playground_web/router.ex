defmodule PlaygroundWeb.Router do
  ...
  pipeline :milligram_css do
    plug :put_root_layout, {PlaygroundWeb.LayoutView, "milligram.html"}
  end
  ...
  scope "/", PlaygroundWeb do
    pipe_through [:browser, :require_authenticated_user, :milligram_css]
